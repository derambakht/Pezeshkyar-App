...
const PatientCard = ({ patient }) => {
  ...
  return (
    <Card className="w-full max-w-md mt-4 p-4 bg-white/90">
      <div className="flex flex-col gap-1">
        <span className="font-bold text-lg">{patient.name}</span>
        <span className="text-sm text-gray-600">سن: {patient.age} سال</span>
        <span className="text-sm text-gray-600">جنسیت: {patient.gender}</span>
